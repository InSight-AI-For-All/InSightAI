      ...
      <main className="legal-page">
        <article className="container">
          ...
          <section id="subscriptions">
            <h2>Subscriptions</h2>
            <p>Starter, Pro, and Max renew monthly until cancelled through the Stripe billing portal. Included checks do not roll over and there are no automatic usage overages. Limits are enforced server-side. Failures before an AI request starts are not counted. Once AI analysis starts, the attempt counts toward your plan even if a result cannot be completed.</p>
          </section>
          <section>
